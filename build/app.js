...
enyo.path.addPaths({layout: "/media/daten/Dropbox/webOS-Apps/Enyo2/tt-rssenyo/enyo/../lib/layout/", onyx: "/media/daten/Dropbox/webOS-Apps/Enyo2/tt-rssenyo/enyo/../lib/onyx/", onyx: "/media/daten/Dropbox/webOS-Apps/Enyo2/tt-rssenyo/enyo/../lib/onyx/source/"});
...
MarkReadTimer = "", gblUseJsonpRequest = !1, gblApiLevel = 0, startcount = 1, enyo.kind({
name: "App",
kind: "FittableRows",
...
components: [ {
kind: "FittableRows",
style: "height: 60px; background: #000000; width: 52px; padding-left: 10px",
ontap: "showHelp",
components: [ {
style: "height: 6px"
}, {
kind: "onyx.IconButton",
src: "assets/bb10help.png",
...
style: "color: #0299cb; font-weight:bold"
}, {
fit: !0
}, {
...
components: [ {
kind: "FittableRows",
style: "height: 45px; background: #444444;",
components: [ {
style: "height: 4px"
}, {
kind: "FittableColumns",
...
name: "lblFeedTitle",
content: "Feed",
style: "font-size:1.4em; padding-top: 4px; color:white; height:30px; font-weight:bold; width:85%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
}, {
style: "width: 10px"
}, {
kind: "onyx.ToggleIconButton",
...
style: " position:fixed; right:5px; height: 30px",
value: !0,
src: "assets/menu-icon-bookmark.png"
} ]
}, {
...
kind: "FittableRows",
name: "bb10marklist",
style: "height: 60px; background: #252525; width: 44px; padding-left: 6px",
...
content: "",
style: "height: auto; font-size: 0.8em; padding-left: 8px; word-wrap: break-word"
}, {
name: "articleViewTitle3",
content: "",
style: "height: auto; font-size: 0.8em; padding-left: 8px; word-wrap: break-word"
} ]
} ]
...
kind: "FittableRows",
style: "background: #252525; width: 30px; padding-right: 5px;",
components: [ {
style: "height: 16px"
}, {
name: "lblArticles1",
align: "center",
style: "font-size: 12px; text-align: center; color: white; height: 20px; padding-top: 1px; padding-bottom: 1px; vertical-align: top;"
}, {
name: "lblArticles2",
align: "center",
style: "font-size: 12px; text-align: center; color: white; height: 20px; padding-top: 1px; padding-bottom: 1px; vertical-align: bottom;"
}, {
style: "height: 3px"
} ]
}, {
kind: "FittableRows",
name: "bb10btnread",
style: "height: 60px; background: #252525; width: 40px; padding-left: 0px",
ontap: "markreadbb10",
components: [ {
style: "height: 6px"
}, {
...
type: "password",
name: "instapaperPW",
placeholder: "Enter instapaper password",
value: "",
style: "width:100%;"
} ]
} ]
...
allowHtml: !0,
onclick: "catchtaponlink",
content: "TE-Reader is a BlackBerry 10 feed reader app. You need to have access to an instance of TinyTiny-RSS (<a href=http://tt-rss.org>tt-rss.org</a>) to use the app! <br><br> TE-Reader was developed by Marcel Meissel and wouldn't have been possible without the contribution of Henk Jonas."
} ]
}, {
tag: "br"
}, {
...
this.inherited(arguments), window.setTimeout(enyo.bind(this, "startapp"), 100);
},
create: function() {
this.inherited(arguments);
},
...
console.log("startApp"), this.setLoadbar(!0), this.$.left.setShowing(!1), this.$.viewPanels.setIndex(1), this.ttrssURL = localStorage.getItem("ttrssurl"), this.ttrssURL == "" ? this.AutoLockPanels = !0 : this.AutoLockPanels = localStorage.getItem("AutoLockPanels") == "true", this.ttrssPassword = localStorage.getItem("ttrsspassword"), this.ttrssUser = localStorage.getItem("ttrssuser"), this.ttrssAutoMarkRead = localStorage.getItem("ttrssautomarkreadtimeout"), this.ViewMode = localStorage.getItem("ViewMode"), this.AutoLoadFirstFeed = localStorage.getItem("AutoLoadFirstFeed") == "true", this.AutoLoadAllArticles = localStorage.getItem("AutoLoadAllArticles") == "true", gblUseJsonpRequest = localStorage.getItem("UseJsonpRequest") == "true", this.instapaperUser = localStorage.getItem("instapaperUser"), this.instapaperPW = localStorage.getItem("instapaperPW"), this.changeViewMode(), this.ttrssURL == null ? (gblBB10 && startcount >= 2 ? (this.multialert("IMPORTANT!\n\nNo Server specified!\n\nPlease enter your TinyTiny RSS Server URL and login credentials. TE-Reader needs access to an instance.\n\nMore info about the open source TinyTiny RSS server can be found at: http://tt-rss.org", "", 15e3), setTimeout(enyo.bind(this, "LoginTap"), 500)) : gblBB10 || (this.multialert("IMPORTANT!\n\nNo Server specified!\n\nPlease enter your TinyTiny RSS Server URL and login credentials. TE-Reader needs access to an instance.\n\nMore info about the open source TinyTiny RSS server can be found at: http://tt-rss.org", "", 15e3), gblWebos || setTimeout(enyo.bind(this, "LoginTap"), 500)), startcount++) : (chkURL = CheckUrl(this.ttrssURL), chkURL ? gblBB10 && startcount >= 2 ? ttrssLogin(this.ttrssURL, this.ttrssUser, this.ttrssPassword, enyo.bind(this, "processLoginSuccess"), enyo.bind(this, "processLoginError")) : gblBB10 || ttrssLogin(this.ttrssURL, this.ttrssUser, this.ttrssPassword, enyo.bind(this, "processLoginSuccess"), enyo.bind(this, "processLoginError")) : gblBB10 && startcount >= 2 ? (this.multialert("CAUTION:\n\nURL doesn't exist or is not reachable!", "", 15e3), setTimeout(enyo.bind(this, "LoginTap"), 500)) : !gblBB10 && !gblFirefox ? (this.multialert("CAUTION:\n\nURL doesn't exist or is not reachable!", "", 15e3), gblWebos || setTimeout(enyo.bind(this, "LoginTap"), 500)) : gblFirefox && ttrssLogin(this.ttrssURL, this.ttrssUser, this.ttrssPassword, enyo.bind(this, "processLoginSuccess"), enyo.bind(this, "processLoginError")), startcount++), window.innerWidth < 1024 ? (this.$.btnFullArticle.setShowing(!1), window.innerWidth > 400 ? (this.$.categoryRepeater.applyStyle("font-size", "1.8em"), this.$.feedRepeater.applyStyle("font-size", "1.8em"), this.$.articleRepeater.applyStyle("font-size", "1.8em"), this.$.articlePreviewScroller.applyStyle("font-size", "1.8em"), this.$.articleViewScroller.applyStyle("font-size", "1.8em"), this.$.articleViewTitle.applyStyle("font-size", "2.0em"), this.$.articleViewTitle2.applyStyle("font-size", "1.6em"), this.$.articleViewTitle3.applyStyle("font-size", "1.6em"), this.$.lblFeedTitle.applyStyle("width", "300px")) : (this.$.categoryRepeater.applyStyle("font-size", "1.2em"), this.$.feedRepeater.applyStyle("font-size", "1.2em"), this.$.articleRepeater.applyStyle("font-size", "1.2em"), this.$.articlePreviewScroller.applyStyle("font-size", "1.2em"), this.$.articleViewScroller.applyStyle("font-size", "1.2em"), this.$.articleViewTitle.applyStyle("font-size", "1.4em"), this.$.articleViewTitle2.applyStyle("font-size", "1.0em"), this.$.articleViewTitle3.applyStyle("font-size", "1.0em"))) : (this.$.viewPanels.layout.peekWidth = 40, this.ViewMode == "0" ? this.$.btnFullArticle.setShowing(!0) : this.$.btnFullArticle.setShowing(!1));
var n = this.$.middle.hasNode().style.width;
n = n.substring(0, n.length - 2), n -= 100, this.$.lblFeedTitle.applyStyle("width", n + "px"), this.debugconsole("Width: " + window.innerWidth + " - " + n + "px"), this.AutoLockPanels && (this.$.btnNextArticle.setShowing(!1), this.$.btnPrevArticle.setShowing(!1)), this.$.useJsonpRequest.setShowing(!1), gblBB10 ? (this.debugconsole("PLATFORM: Blackberry 10"), this.setViewBB10()) : gblPlaybook ? (this.debugconsole("PLATFORM: PlaybookOS"), this.setViewPlaybook()) : gblFirefox ? (this.debugconsole("PLATFORM: FirefoxOS"), this.setViewFFOS()) : gblWebos ? (this.debugconsole("PLATFORM: webOS"), this.setViewWebOS()) : gblDesktop ? (this.debugconsole("PLATFORM: Desktop"), this.setViewDesktop()) : this.setViewDesktop();
},
debugconsole: function(e) {
gblDebug && console.log(e);
},
resizeHandler: function() {
this.inherited(arguments), window.innerWidth < 1024 ? (this.$.btnFullArticle.setShowing(!1), window.innerWidth > 400 ? (this.$.categoryRepeater.applyStyle("font-size", "1.8em"), this.$.feedRepeater.applyStyle("font-size", "1.8em"), this.$.articleRepeater.applyStyle("font-size", "1.8em"), this.$.articlePreviewScroller.applyStyle("font-size", "1.8em"), this.$.articleViewScroller.applyStyle("font-size", "1.8em"), this.$.articleViewTitle.applyStyle("font-size", "2.0em"), this.$.articleViewTitle2.applyStyle("font-size", "1.6em"), this.$.articleViewTitle3.applyStyle("font-size", "1.6em")) : (this.$.categoryRepeater.applyStyle("font-size", "1.2em"), this.$.feedRepeater.applyStyle("font-size", "1.2em"), this.$.articleRepeater.applyStyle("font-size", "1.2em"), this.$.articlePreviewScroller.applyStyle("font-size", "1.2em"), this.$.articleViewScroller.applyStyle("font-size", "1.2em"), this.$.articleViewTitle.applyStyle("font-size", "1.4em"), this.$.articleViewTitle2.applyStyle("font-size", "1.0em"), this.$.articleViewTitle3.applyStyle("font-size", "1.0em"))) : (this.$.viewPanels.layout.peekWidth = 40, this.ViewMode == "0" ? this.$.btnFullArticle.setShowing(!0) : this.$.btnFullArticle.setShowing(!1));
},
resize: function() {
this.$.left2.reflow(), this.$.middle.reflow(), this.$.left2blank.reflow(), this.$.feedRepeater.reflow(), this.$.body.reflow();
var e = this.$.middle.hasNode().style.width;
e = e.substring(0, e.length - 2), e -= 100, this.debugconsole("Width: " + this.$.middle.hasNode().style.width + " - " + e), this.$.lblFeedTitle.applyStyle("width", e + "px"), this.resized();
},
setViewBB10: function() {
this.$.btnSettings.setShowing(!1), this.$.setupinstapaper.setShowing(!1), this.$.listviewgrabber.setShowing(!1), this.$.bb10listviewgrabber.setShowing(!0), this.$.btnUnlockPanels.setShowing(!1), this.$.bb10articleviewgrabber.setShowing(!0), this.$.grabberArticleView.setShowing(!1), this.$.bb10btnshare.setShowing(!0), this.$.btnshare.setShowing(!1), this.$.bb10btnread.setShowing(!0), this.$.chkArticleRead.applyStyle("height", "20px"), this.$.chkArticleRead.setShowing(!1), this.staredon = "assets/bb10staron.png", this.staredoff = "assets/bb10staroff.png", this.$.iconStarred.setSrc(this.staredoff), this.publishedon = "assets/bb10publishon.png", this.publishedoff = "assets/bb10publishoff.png", this.$.btnbrowser.setSrc("assets/bb10browser.png"), this.$.btnNextArticle.setShowing(!1), this.$.btnPrevArticle.setShowing(!1);
},
setViewPlaybook: function() {
this.$.btnSettings.setShowing(!0), this.$.setupinstapaper.setShowing(!1), this.$.listviewgrabber.setShowing(!0), this.$.bb10listviewgrabber.setShowing(!1), this.$.btnUnlockPanels.setShowing(!1), this.$.bb10articleviewgrabber.setShowing(!1), this.$.grabberArticleView.setShowing(!0), this.$.bb10btnshare.setShowing(!0), this.$.btnshare.setShowing(!1), this.$.bb10btnread.setShowing(!0), this.$.chkArticleRead.applyStyle("height", "20px"), this.$.chkArticleRead.setShowing(!1), this.staredon = "assets/bb10staron.png", this.staredoff = "assets/bb10staroff.png", this.$.iconStarred.setSrc(this.staredoff), this.publishedon = "assets/bb10publishon.png", this.publishedoff = "assets/bb10publishoff.png", this.$.btnbrowser.setSrc("assets/bb10browser.png"), this.$.btnNextArticle.setShowing(!0), this.$.btnPrevArticle.setShowing(!0);
},
setViewFFOS: function() {
this.$.btnSettings.setShowing(!0), this.$.setupinstapaper.setShowing(!1), this.$.listviewgrabber.setShowing(!1), this.$.bb10listviewgrabber.setShowing(!0), this.$.bb10listviewgrabber.setSrc("assets/ffxospanelBack.png"), this.$.btnUnlockPanels.setShowing(!1), this.$.bb10articleviewgrabber.setShowing(!0), this.$.bb10articleviewgrabber.setSrc("assets/ffxospanelBack.png"), this.$.grabberArticleView.setShowing(!1), this.$.bb10btnshare.setShowing(!0), this.$.btnshare.setShowing(!1), this.$.articletoolbarright.setShowing(!1), this.$.FeedListPageUpButton.setShowing(!1), this.$.FeedListPageDownButton.setShowing(!1), this.$.bb10btnread.setShowing(!0), this.$.chkArticleRead.applyStyle("height", "20px"), this.$.chkArticleRead.setShowing(!1), this.staredon = "assets/bb10staron.png", this.staredoff = "assets/bb10staroff.png", this.$.iconStarred.setSrc(this.staredoff), this.publishedon = "assets/bb10publishon.png", this.publishedoff = "assets/bb10publishoff.png", this.$.btnbrowser.setSrc("assets/bb10browser.png"), this.$.btnNextArticle.setShowing(!1), this.$.btnPrevArticle.setShowing(!1);
},
setViewWebOS: function() {
this.$.btnreadontouch.setShowing(!0), this.setViewBB10(), this.$.btnSettings.setShowing(!0), this.$.btnNextArticle.setShowing(!0), this.$.btnPrevArticle.setShowing(!0);
},
...
processCheckUrlError: function(e, t) {
...
this.$.autoLoadFirstFeed.setValue(this.AutoLoadFirstFeed), this.$.autoLoadAllArticles.setValue(this.AutoLoadAllArticles), console.log(this.AutoLockPanels);
...
gblBB10 && this.$.autoLockPanels.setShowing(!1), this.ViewMode == "1" ? (this.$.articlePreviewScroller.setShowing(!0), this.$.articleViewScroller.setShowing(!1), this.$.body.setShowing(!1), gblBB10 ? (this.$.FeedListPageUpButton.setShowing(!1), this.$.FeedListPageDownButton.setShowing(!1), this.$.autoLockPanels.setShowing(!1)) : gblFirefox ? (this.$.FeedListPageUpButton.setShowing(!1), this.$.FeedListPageDownButton.setShowing(!1), this.$.autoLockPanels.setShowing(!1)) : (this.$.FeedListPageUpButton.setShowing(!0), this.$.FeedListPageDownButton.setShowing(!0))) : this.ViewMode == "2" ? (this.$.articlePreviewScroller.setShowing(!1), this.$.articleViewScroller.setShowing(!0), this.$.body.setShowing(!0), this.$.FeedListPageUpButton.setShowing(!1), this.$.FeedListPageDownButton.setShowing(!1)) : (this.$.articlePreviewScroller.setShowing(!0), this.$.articleViewScroller.setShowing(!1), this.$.body.setShowing(!0), this.$.FeedListPageUpButton.setShowing(!1), this.$.FeedListPageDownButton.setShowing(!1));
},
...
this.AutoLoadAllArticles && (this.$.lblFeedTitle.setContent("All articles"), this.$.feedTitleIcon.setShowing(!1), ttrssGetHeadlines(this.ttrssURL, this.ttrss_SID, t, -4, !1, enyo.bind(this, "processGetHeadlinesSuccess"), enyo.bind(this, "processGetHeadlinesError")), window.innerWidth < 1024 && (this.$.viewPanels.setIndex(2), this.debugconsole("SETPANEL 1")));
},
processLoginError: function(e) {
console.error("LOGIN Error: " + e.error), this.multialert("LOGIN Error: " + e.error, "Login Error", 1e4), this.$.main.setContent("LOGIN ERROR: " + e.error), setTimeout(enyo.bind(this, "LoginTap"), 500);
},
...
if (e.length == 0) {
this.debugconsole("GetCategories: NO Categories"), this.setLoadbar(!1), this.multialert("Sorry, no news!", " ", 5e3), this.setLoadbar(!1);
return;
}
var t = "";
...
console.error("processGetCategoriesError"), console.error(e), this.multialert(e, "Get Categories Error", 1e4), this.setLoadbar(!1);
},
...
this.debugconsole(e), this.setLoadbar(!1);
},
processGetConfigSuccess: function(e) {
this.$.LoginPopup.hide(), this.ttrssIconPath = this.ttrssURL + "/" + e.icons_url + "/", console.log(e.icons_url);
},
processGetConfigError: function(e) {
this.debugconsole(e), this.$.LoginPopup.hide();
},
processGetApiLevelSuccess: function(e) {
gblApiLevel = e.level, this.$.LoginPopup.hide();
},
...
if (e.length == 0) {
this.debugconsole("GetHeadlines: NO HEADLINES"), this.setLoadbar(!1), this.$.articleRepeater.setCount(0), this.$.articleScroller.setScrollTop(0), this.$.viewPanels.setIndex(1), this.debugconsole("SETPANEL 2"), this.clickRefresh();
return;
}
...
this.$.articleViewTitle.setContent(html_entity_decode(e[0].title)), this.$.articleViewTitle2.setContent(o), this.$.articleViewTitle3.setContent(html_entity_decode(e[0].author)), this.$.articleViewScroller.setShowing(!1), this.$.articlePreviewScroller.setShowing(!0), helperimage = "", this.$.articlePreview.setContent(helperimage + e[0].content), this.debugconsole(e[0]), this.debugconsole(helperimage), this.$.articlePreviewScroller.setScrollTop(0), this.$.articlePreviewScroller.setScrollLeft(0), e[0].unread ? (this.$.chkArticleRead.setChecked(!1), this.$.bb10iconread.setSrc("assets/bb10readoff.png"), clearTimeout(this.MarkReadTimer), this.ttrssAutoMarkRead != "0" && (this.MarkReadTimer = setTimeout(enyo.bind(this, "TimedMarkRead"), this.ttrssAutoMarkRead))) : (this.$.chkArticleRead.setChecked(!0), this.$.bb10iconread.setSrc("assets/bb10readon.png")), e[0].marked ? this.$.iconStarred.setSrc(this.staredon) : this.$.iconStarred.setSrc(this.staredoff), e[0].published ? this.$.iconPublished.setSrc(this.publishedon) : this.$.iconPublished.setSrc(this.publishedoff), this.$.lblArticles1.setContent(this.RecentArticleIndex + 1), this.$.lblArticles2.setContent(this.Articles.length), this.$.articleTitleIcon.setSrc(this.ttrssIconPath + e[0].feed_id + ".ico"), this.resize(), this.setLoadbar(!1);
},
...
this.$.iconPublished.src == this.publishedoff ? (this.debugconsole("PUBLISH"), ttrssPublishArticle(this.ttrssURL, this.ttrss_SID, this.ArticleID[this.RecentArticleIndex], !0, enyo.bind(this, "processPublishArticleSuccess"), enyo.bind(this, "processPublishArticleError")), this.$.iconPublished.setSrc(this.publishedon)) : (this.debugconsole("UNPUBLISH"), ttrssPublishArticle(this.ttrssURL, this.ttrss_SID, this.ArticleID[this.RecentArticleIndex], !1, enyo.bind(this, "processPublishArticleSuccess"), enyo.bind(this, "processPublishArticleError")), this.$.iconPublished.setSrc(this.publishedoff));
},
...
var n = t.index, r = t.item;
n == this.currentFeedIndex ? (r.$.titel.applyStyle("font-weight", "bold"), r.$.unread.applyStyle("font-weight", "bold")) : (r.$.titel.applyStyle("font-weight", "normal"), r.$.unread.applyStyle("font-weight", "normal")), this.FeedIcon[n] && (console.log(this.ttrssIconPath), r.$.icon.setSrc(this.ttrssIconPath + this.FeedID[n] + ".ico")), r.$.unread.setContent(this.FeedUnread[n]), r.$.titel.setContent(this.FeedTitle[n]), this.resize(), n + 1 == this.FeedID.length && this.setLoadbar(!1);
},
...
var n = this.$.toggleUnread.getValue();
ttrssGetFeeds(this.ttrssURL, this.ttrss_SID, n, this.CategoryID[e], enyo.bind(this, "processGetFeedsSuccess"), enyo.bind(this, "processGetFeedsError")), this.$.viewPanels.setIndex(1), this.debugconsole("SETPANEL 3");
},
clickFeed: function(e, t) {
this.selectFeed(t.index), this.setLoadbar(!0);
},
...
e == "0" && (i = !0), this.currentFeedID = this.FeedID[e], ttrssGetHeadlines(this.ttrssURL, this.ttrss_SID, r, this.FeedID[e], i, enyo.bind(this, "processGetHeadlinesSuccess"), enyo.bind(this, "processGetHeadlinesError")), window.innerWidth < 1024 && (this.$.viewPanels.setIndex(2), this.debugconsole("SETPANEL 4"));
},
addFeedClick: function(e, t) {
this.currentCategoryIndex + 1 <= 0 ? this.multialert("Select category first", "", 5e3) : (this.$.AddFeedCategory.setContent(this.CategoryTitle[this.currentCategoryIndex]), this.$.AddFeedPopup.show(), gblBB10 && (this.debugconsole("IN CLIPBOARD: " + community.clipboard.getText()), this.$.AddFeedURL.setValue(community.clipboard.getText())));
},
...
this.clickRefresh(), this.$.viewPanels.setIndex(0), this.debugconsole("SETPANEL 5"), this.getCategories();
},
addFeedError: function(e) {
this.debugconsole(e), this.$.main.setContent(e);
},
...
this.clickRefresh(), this.$.viewPanels.setIndex(1), this.debugconsole("SETPANEL 6");
},
...
this.debugconsole(e), this.selectFeed(this.currentFeedIndex);
},
processUpdateFeedError: function(e) {
console.error(e);
},
holdItem: function(e, t) {
window.innerWidth < 1024 && this.ViewMode == 0 && (this.$.viewPanels.setIndex(3), this.debugconsole("SETPANEL 7"), this.$.left2.setShowing(!1), this.$.middle.setShowing(!1), gblBB10 || gblWebos ? this.$.btnUnlockPanels.setShowing(!1) : this.$.btnUnlockPanels.setShowing(!0), this.$.btnPrevArticle.setShowing(!1), this.$.btnNextArticle.setShowing(!1), this.$.grabberArticleView.setShowing(!1), this.$.viewPanels.setDraggable(!1), this.debugconsole("Disable Panels"), this.clickItem(" ", t), this.resize());
},
enablePanels: function(e, t) {
this.debugconsole("ENABLE Panels"), this.UpdateFeedClick(), this.$.left2.setShowing(!0), this.$.middle.setShowing(!0), this.$.btnUnlockPanels.setShowing(!1), this.$.btnPrevArticle.setShowing(!0), this.$.btnNextArticle.setShowing(!0), gblBB10 ? this.$.grabberArticleView.setShowing(!1) : gblFirefox ? this.$.grabberArticleView.setShowing(!1) : this.$.grabberArticleView.setShowing(!0), this.$.viewPanels.setIndex(2), this.debugconsole("SETPANEL 8"), this.resize(), this.$.viewPanels.setDraggable(!0);
},
...
var n = this.ArticleURL[this.RecentArticleIndex];
n.indexOf("www.zeit.de") > 0 && (n = n.replace("www.zeit.de", "mobil.zeit.de"));
if (gblBB10) blackberry.invoke.invoke({
target: "sys.browser",
uri: n
}); else if (gblPlaybook) {
var r = "";
r = n.replace(/:/g, "%3A"), r = r.replace(/%3A/, ":"), r = r.replace(/&/g, "&"), console.log("PLAYBOOK URL open " + r);
if (typeof blackberry != "undefined") try {
var i = new blackberry.invoke.BrowserArguments(r);
blackberry.invoke.invoke(blackberry.invoke.APP_BROWSER, i);
} catch (s) {
alert("Sorry, there was a problem invoking the browser");
} else alert("Sorry, there was a problem invoking the PlayBook browser");
} else if (gblFirefox) var o = new MozActivity({
name: "view",
data: {
type: "url",
url: n
...
var n = this.ArticleURL[this.RecentArticleIndex];
n.indexOf("www.zeit.de") > 0 && (n = n.replace("www.zeit.de", "mobil.zeit.de")), ShareText = this.ArticleData[this.RecentArticleIndex][0].title;
...
case "Instapaper":
var r = new enyo.Ajax({
url: "https://www.instapaper.com/api/add?username=" + this.instapaperUser + "&password=" + this.instapaperPW + "&redirect=close&url=" + n,
method: "GET"
});
r.response(function() {}), r.go();
break;
case "ReadOnTouch":
this.debugconsole("ROTouch");
}
},
...
this.debugconsole("success");
}, function(e) {
this.debugconsole("error: " + e);
});
}
if (gblFirefox) var r = new MozActivity({
name: "share",
data: {
type: "url",
url: this.ShareUrl
...
gblPlaybook && this.$.sharePopup.show(), gblWebos && this.$.sharePopup.show(), gblDesktop && this.$.sharePopup.show();
},
...
switch (r) {
case 3:
this.$.viewPanels.setIndex(2), this.debugconsole("SETPANEL 13");
break;
case 2:
this.$.viewPanels.setIndex(1), this.debugconsole("SETPANEL 14");
}
...
gblDesktop || (this.debugconsole("DRAGSTOP " + t.dx), this.resize(), +t.dx < -120 && this.dragStartPanelIndex == 3 && this.$.viewPanels.getIndex() == 3 && this.nextArticle(), +t.dx > 120 && (this.$.btnUnlockPanels.getShowing() && !gblFirefox && this.prevArticle(), this.$.bb10articleviewgrabber.getShowing() && this.prevArticle()), this.resize());
},
...
this.debugconsole("Unsubscribe Error: " + t), this.clickRefresh();
},
unsubscribeFeedSuccess: function(e, t) {
this.debugconsole("Unsubscribe Success: " + t), this.clickRefresh(), this.$.viewPanels.setIndex(0), this.debugconsole("SETPANEL 16");
},
...
multialert: function(e, t, n) {
if (gblBB10) {
var r = e, i = "Ok", s, o = {
buttonText: i,
timeout: n
};
s = blackberry.ui.toast.show(e, o);
} else gblWebos ? (this.$.InfoPopup.show(), this.$.InfoPopupText.setContent(e)) : alert(e);
},
